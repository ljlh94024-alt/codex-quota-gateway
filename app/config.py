...
class Settings:
    ...
    stream_idle_timeout: float = float(os.getenv("STREAM_IDLE_TIMEOUT_SECONDS", "90"))
    stream_max_seconds: float = float(os.getenv("STREAM_MAX_SECONDS", "180"))
    queue_timeout_seconds: float = float(os.getenv("QUEUE_TIMEOUT_SECONDS", "60"))
